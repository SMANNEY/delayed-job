...
* Option to start a monitor process
* Added CouchDB backend
* Normalize logging messages 
* New pure-YAML serialization
* Added Rails 3 generator
* Deprecated @#send_later@ and @#send_at@
* Added @#delay@ to Object that allows you to delay any method and pass 
options:
<pre>options = {:priority => 19, :run_at => 5.minutes.from_now}
